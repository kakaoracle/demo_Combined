package loadAndInstanceBean;

import com.abc.loadAndInstanceBean.constant.ParseType;
import com.abc.loadAndInstanceBean.context.ApplicationContext;
...
public class BeanTest {
    ...
    public void testClassLoader(){
        ...
        //测试带文件名的一个文件的位置
        URL resource4 = BeanTest.class.getClassLoader().getResource("FileURLUtil.java");
